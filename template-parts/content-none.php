...
<section class="no-results not-found">
	...
	<div class="page-content">
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			printf(
				wp_kses(
					...
					esc_html__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'custom' ),
					[
						'a' => [
							'href' => [],
						],
		...
		<?php elseif ( is_search() ) : ?>
			...
			<?php get_search_form(); ?>
		<?php else : ?>
			<p><?php esc_html_e( 'It seems we can\'t find what you\'re looking for. Perhaps searching can help.', 'custom' ); ?></p>
			<?php get_search_form(); ?>
		<?php endif; ?>
	</div><!-- .page-content -->
